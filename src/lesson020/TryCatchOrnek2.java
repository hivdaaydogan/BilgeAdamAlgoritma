...
//			}
//		}
//		System.out.println("toplam: " + toplam + " hata sayısı: " + count);
	}
	...
	public static void sum(String[] array) {
		...
		System.out.println("Array'deki sayıların toplamı: " + toplam + " hatalı işlemler: " + hataToplam);
	}
